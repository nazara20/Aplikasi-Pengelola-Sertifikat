                ...
                <div class="col-sm-12">
                    <div class="page-title-box">
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                <h4 class="page-title mb-0">Edit Data Pembayaran</h4>
                            </div>
                            <div class="col-md-4">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <input type="hidden" name="id" value="<?= $editpembayaran['id']; ?>">
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">No SPS</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" id="No_SPS" name="No_SPS" value="<?= $editpembayaran['No_SPS']; ?>" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <select name="No_Pendaftaran" id="No_Pendaftaran" class="select2 form-control custom-select">
                                            <option value="<?= $editpembayaran['No_Pendaftaran']; ?>"><?= $editpembayaran['No_Pendaftaran']; ?></option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" id="Jumlah_Biaya" name="Jumlah_Biaya" value="<?= $editpembayaran['Jumlah_Biaya']; ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" id="Terbilang" name="Terbilang" value="<?= $editpembayaran['Terbilang']; ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="date" id="Tgl_SPS" name="Tgl_SPS" value="<?= $editpembayaran['Tgl_SPS']; ?>">
