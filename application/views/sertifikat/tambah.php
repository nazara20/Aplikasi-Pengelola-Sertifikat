                        ...
                        <div class="card-body">
                            <form action="<?= base_url('sertifikat/tambah'); ?>" method="POST">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" id="No_Sertifikat" name="No_Sertifikat" value="<?= $kodeuniksertifikat; ?>" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="date" id="Tgl_Pengesahan" name="Tgl_Pengesahan" value="<?= set_value('Tgl_Pengesahan')?>" >
                                    </div>
                                </div>
