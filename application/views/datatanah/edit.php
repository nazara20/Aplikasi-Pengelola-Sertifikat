                ...
                <div class="col-sm-12">
                    <div class="page-title-box">
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                <h4 class="page-title mb-0">Edit Data Tanah</h4>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted m-b-30 font-14">isi form edit data tanah dengan benar</p>
                            <?= form_open_multipart(''); ?>
                            <input type="hidden" name="id" value="<?= $editdatatanah['id']; ?>">
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">No HAK</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="number" id="No_HAK" name="No_HAK" value="<?= $editdatatanah['No_HAK']; ?>" readonly>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="No_KTP" id="No_KTP" class="select2 form-control custom-select">
                                        <option value="<?= $editdatatanah['No_KTP']; ?>"><?= $editdatatanah['No_KTP']; ?></option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" id="Letak_Bidang_Tnh" name="Letak_Bidang_Tnh" value="<?= $editdatatanah['Letak_Bidang_Tnh']; ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" id="Luas_Tnh" name="Luas_Tnh" value="<?= $editdatatanah['Luas_Tnh']; ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" id="Status_tnh" name="Status_tnh" value="<?= $editdatatanah['Status_tnh']; ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" id="No_kohir" name="No_kohir" value="<?= $editdatatanah['No_kohir']; ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" id="No_Persil" name="No_Persil" value="<?= $editdatatanah['No_Persil']; ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" id="Nama_pewaris" name="Nama_pewaris" value="<?= $editdatatanah['Nama_pewaris']; ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" id="Meninggal_thn" name="Meninggal_thn" value="<?= $editdatatanah['Meninggal_thn']; ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <embed type="application/pdf" src="<?= base_url('admin/img/datatanah/') . $editdatatanah['Surat_waris']; ?>" width="300" height="300"></embed>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Nama Pemberi hibah</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" id="Nama_pmbri_hibah" name="Nama_pmbri_hibah" value="<?= $editdatatanah['Nama_pmbri_hibah']; ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input class="form-control" type="date" id="tgl_hibah" name="tgl_hibah" value="<?= $editdatatanah['tgl_hibah']; ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" id="No_akta_hibah" name="No_akta_hibah" value="<?= $editdatatanah['No_akta_hibah']; ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input class="form-control" type="date" id="tgl_pembelian" name="tgl_pembelian" value="<?= $editdatatanah['tgl_pembelian']; ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" id="Nm_PPAT_pembelian" name="Nm_PPAT_pembelian" value="<?= $editdatatanah['Nm_PPAT_pembelian']; ?>">
