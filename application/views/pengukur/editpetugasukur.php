                ...
                <div class="col-12">
                    <div class="card col-sm-6">
                        <div class="card-body">
                            ...
                            <input type="hidden" name="id" value="<?= $editpetugasukur['id']; ?>">
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">NIP Petugas</label>
                                    <div class="col-sm-8">
                                        <input class="form-control" type="text" id="Nip_petugas" name="Nip_petugas" value="<?= $editpetugasukur['Nip_petugas']; ?>">
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control" type="text" id="Nama_Petugas" name="Nama_Petugas" value="<?= $editpetugasukur['Nama_Petugas']; ?>" >
                                    </div>
