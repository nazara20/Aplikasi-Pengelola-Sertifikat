                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('pengukur/tambah'); ?>" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="Nip_petugas" id="select2-with-placeholdera" class="select2 form-control custom-select">
                                            <option value="">Pilih NIP Petugas</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div id="the-basics">
                                        <input class="form-control" type="text" id="Provinsi" name="Provinsi" value="<?= set_value('Provinsi')?>">
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div id="the-basics">
                                        <input class="form-control" type="text" id="Kecamatan" name="Kecamatan" value="<?= set_value('Kecamatan')?>">
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div id="the-basics">
                                        <input class="form-control" type="text" id="Kelurahan" name="Kelurahan" value="<?= set_value('Kelurahan')?>">
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div id="the-basics">
                                        <input class="form-control" type="text" id="RT/RW" name="RT/RW" value="<?= set_value('RT/RW')?>">
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div id="the-basics">
                                        <input class="form-control" type="text" id="Batas_utara" name="Batas_utara" value="<?= set_value('Batas_utara')?>">
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div id="the-basics">
                                        <input class="form-control" type="text" id="Batas_selatan" name="Batas_selatan" value="<?= set_value('Batas_selatan')?>">
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div id="the-basics">
                                        <input class="form-control" type="text" id="Batas_Barat" name="Batas_Barat" value="<?= set_value('Batas_Barat')?>">
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div id="the-basics">
                                        <input class="form-control" type="text" id="Batas_timur" name="Batas_timur" value="<?= set_value('Batas_timur')?>">
                                        </div>
