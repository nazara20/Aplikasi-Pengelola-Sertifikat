                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('pendaftaran/tambah'); ?>" method="POST">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" id="nopendaftaran" name="nopendaftaran" value="<?= $kodeunikdaftar; ?>" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div id="the-basics">
                                        <input class="form-control" type="text" id="noktpkuasa" name="noktpkuasa" value="<?= set_value('noktpkuasa')?>" placeholder="isi no KTP kuasa">
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" id="nosuratkuasa" name="nosuratkuasa" value="<?= $kodeuniksurat; ?>" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Tanggal Surat Kuasa</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" id="tanggalsuratkuasa" name="tanggalsuratkuasa" value="<?= date("d F Y"); ?>" readonly>
                                    </div>
                                </div>
