...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="<?= base_url('admin/'); ?>img/logotitlebpnlgiht.svg">
    <title><?= $title; ?></title>
   ...
   <!-- DataTables -->
   <link href="<?= base_url('admin/'); ?>/plugins/datatables/dataTables.bootstrap4.min.css" rel="stylesheet" type="text/css" />
        <link href="<?= base_url('admin/'); ?>/plugins/datatables/buttons.bootstrap4.min.css" rel="stylesheet" type="text/css" />
        <!-- Responsive datatable examples -->
        <link href="<?= base_url('admin/'); ?>/plugins/datatables/responsive.bootstrap4.min.css" rel="stylesheet" type="text/css" />
